...
#create_clock -period 20 [get_ports GPIO_0[1]]
#create_clock -name FSYNCclk -period 20 [get_ports GPIO_0[3]]
#create_clock -name LSYNCclk -period 20 [get_ports GPIO_0[5]]
#create_clock -name DATAclk -period 20 [get_ports GPIO_0[7]]
#create_clock -name CLKclk -period 20 [get_ports GPIO_0[9]]
#create_clock -name CNVTclk -period 20 [get_ports GPIO_0[11]]
#create_clock -name SYNCclk -period 20 [get_ports GPIO_0[13]]
#create_clock -name MASTERclk -period 20

create_clock -name FSYNCclk -period 20
create_clock -name LSYNCclk -period 20
create_clock -name DATAclk  -period 20
create_clock -name CLKclk   -period 20
create_clock -name CNVTclk  -period 20
create_clock -name SYNCclk  -period 20

#create_clock -period 20 [get_ports GPIO_0[13]]
...
set_output_delay -clock MASTERclk -max 0  [get_ports GPIO_0[1]]
set_output_delay -clock MASTERclk -min 0  [get_ports GPIO_0[1]]
...
#set_output_delay -min -clock GPIO_0[3] 0  [get_ports GPIO_0[3]]
#set_output_delay -max -clock GPIO_0[5] 0  [get_ports GPIO_0[5]]
#set_output_delay -min -clock GPIO_0[5] 0  [get_ports GPIO_0[5]]
#set_output_delay -max -clock GPIO_0[7] 0  [get_ports GPIO_0[7]]
#set_output_delay -min -clock GPIO_0[7] 0  [get_ports GPIO_0[7]]
#set_output_delay -max -clock GPIO_0[9] 0  [get_ports GPIO_0[9]]
#set_output_delay -min -clock GPIO_0[9] 0  [get_ports GPIO_0[9]]
#set_output_delay -max -clock GPIO_0[11] 0  [get_ports GPIO_0[11]]
#set_output_delay -min -clock GPIO_0[11] 0  [get_ports GPIO_0[11]]
#set_output_delay -max -clock GPIO_0[13] 0  [get_ports GPIO_0[13]]
#set_output_delay -min -clock GPIO_0[13] 0  [get_ports GPIO_0[13]]
